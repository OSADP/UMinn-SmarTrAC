...
/**
 * The place content provider which use google places API to fetch places
...
public class PlaceProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.smartracumn.smartracmodel.PlaceProvider";
	...
	public static final Uri SUGGESTS_URI = Uri.parse("content://" + AUTHORITY
	...
	String mKey = "key=AIzaSyAa8T9Y_omYRNgu8RIMvjOMC3n5sXKT3Mk";

	// Defines a set of uris allowed with this content provider
	private static final UriMatcher mUriMatcher = buildUriMatcher();

	/**
	 * Build URI Mtacher for content provider.
	 * 
	 * @return Content provider uri matcher.
	 */
	...
	/**
	 * Query google places api based on user intention.
	 */
	@Override
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case DETAILS:
			// Defining a cursor object with columns description, lat and lng
			mCursor = new MatrixCursor(new String[] { "_id", "description",
					"lat", "lng" });
	...
	/**
	 * Download places string from uri.
	 * 
	 * @param strUrl
	 *            The url from where the data is fetched.
	 * @return Html string from website.
	 * @throws IOException
	 */
	...
	/**
	 * Get google place detail url based on reference.
	 * 
	 * @param ref
	 *            The place reference.
	...
	/**
	 * Get google places url based on user query.
	 * 
	 * @param qry
	 *            User query.
	...
	/**
	 * Get place details string.
	 * 
	 * @param reference
	 *            Place reference string.
	 * @return html string.
	 */
